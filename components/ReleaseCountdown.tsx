...
function getUpcomingRelease(now: Date) {
  ...
  const releases = [
    { close: new Date(year, 5, 15, 23, 59, 59), release: new Date(year, 6, 1, 0, 0, 0), end: new Date(year, 6, 1, 23, 59, 59) },
    { close: new Date(year, 8, 15, 23, 59, 59), release: new Date(year, 9, 1, 0, 0, 0), end: new Date(year, 9, 1, 23, 59, 59) },
    { close: new Date(year, 11, 15, 23, 59, 59), release: new Date(year + 1, 0, 1, 0, 0, 0), end: new Date(year + 1, 0, 1, 23, 59, 59) },
    { close: new Date(year + 1, 2, 15, 23, 59, 59), release: new Date(year + 1, 3, 1, 0, 0, 0), end: new Date(year + 1, 3, 1, 23, 59, 59) },
  ];

  return releases.find((item) => now <= item.end) || releases[0];
}
