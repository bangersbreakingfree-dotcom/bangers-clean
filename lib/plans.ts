...
export const planGroups = [
  ...
  { tier: 'adventurer' as Tier, name: 'Adventurer Edition', size: '16x20', quarterly: '$69', annual: '$248', description: 'The balanced premium size for collectors who want a real statement piece.' },
...
export const plans = [
  ...
  { tier: 'adventurer', name: 'Adventurer Edition', size: '16x20', billing: 'quarterly', amount: '$69', priceEnv: 'STRIPE_PRICE_ADVENTURER_QUARTERLY' },
  { tier: 'adventurer', name: 'Adventurer Edition', size: '16x20', billing: 'annual', amount: '$248', priceEnv: 'STRIPE_PRICE_ADVENTURER_ANNUAL' },
